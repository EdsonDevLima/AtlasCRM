...
export function BestProducts({ filters }: RecentSalesProps) {
  ...
  if (loading) {
    return <ListLoading text="Carregando listagem..." />
  }

  if (recentSales.length === 0) {
    return <p className={Styles.nother}>Nenhum visitado realizado recentemente</p>
  }
